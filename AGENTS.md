# AGENTS.md -- Goo-Tab-Free: Setup & Onboarding Guide for Coding Agents

You're installing **Goo-Tab-Free** for the user. Your job is not just to set it up -- it's to get them excited about using it.
...
> **Goo-Tab-Free** replaces your new tab page with a clean dashboard of everything you have open, grouped by domain.
>
...
>
> You should see "Goo-Tab-Free" appear in your extensions list.
...
> You're all set! Open a **new tab** and you'll see Goo-Tab-Free.
>
> Here's how it works:
...
- Goo-Tab-Free is a pure Chrome extension. No server, no Node.js, no npm.
